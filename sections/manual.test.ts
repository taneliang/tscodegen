...
describe(extractManualSections, () => {
  ...
  test('should ignore malformed manual sections', () => {
    expect(extractManualSections('/* BEGIN MANUAL SECTION *//* END MANUAL SECTION */')).toEqual({});
    expect(extractManualSections('/* BEGIN MANUAL SECTION no_end_designator *//* END */')).toEqual(
      {},
    );
    expect(
      extractManualSections(
...
describe(emptyManualSections, () => {
  ...
  test('should passthrough code that has malformed manual sections', () => {
    expectEmptyManualSectionsToPassthrough('/* BEGIN MANUAL SECTION *//* END MANUAL SECTION */');
    expectEmptyManualSectionsToPassthrough('/* BEGIN MANUAL SECTION no_end_designator *//* END */');
    expectEmptyManualSectionsToPassthrough(
      '/* BEGIN MANUAL SECTION key with whitespace *//* END MANUAL SECTION */',
    );
  });
...
/* END MANUAL SECTION */`;
  ...
  test('should reset an empty manual section', () => {
    expect(emptyManualSections('/* BEGIN MANUAL SECTION key *//* END MANUAL SECTION */')).toBe(
      expectedEmptySectionForSectionKey('key'),
    );
    expect(emptyManualSections('/* BEGIN MANUAL SECTION key */\n/* END MANUAL SECTION */')).toBe(
      expectedEmptySectionForSectionKey('key'),
    );
    expect(
